...
- **Backend**: Django
- **Machine Learning**: MATLAB for prediction calculations, Random Forest Classifier with scikit-learn
- **Frontend**: Next.js
- **Database**: PostgreSQL
...
For more information or to get involved, please contact me directly at [erik.cupsa@mail.mcgill.ca](mailto:erik.cupsa@mail.mcgill.ca).
